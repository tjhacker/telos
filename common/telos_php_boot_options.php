...
echo ":rocky\n";
echo "#Rocky\n";
echo "kernel http://juno.load/rocky/x86_64/images/pxeboot/vmlinuz proxy=" . $proxy . " text repo=http://juno.load/rocky/x86_64 text  ks=http://juno.load/ks-rocky.cfg initrd=initrd.img \n";
